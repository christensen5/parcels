...
===================================
The manuscript detailing this first release of Parcels, version 0.9, has been accepted for publication in  `Geoscientific Model Development <https://doi.org/10.5194/gmd-2017-167>`_ and can be cited as 
